        ...
        <motion.div
          ...
          <div className="flex flex-col">
            <div className="relative rounded-2xl overflow-hidden flex-1" style={{ minHeight: '420px' }}>
              <img src="https://media.base44.com/images/public/69d4989a834518931660bae7/39b613c97_generated_cf7a412f.png"

              alt={galleryImages[0].alt} className="w-full h-full object-cover"
