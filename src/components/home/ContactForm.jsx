    ...
    >
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="font-body text-mist-grey text-base">
        ...
        >
          ...
          <Button
            type="submit"
            disabled={sending}
            className="w-full bg-sky-horizon text-deep-atlantic font-body font-semibold py-5 hover:bg-sky-horizon/90 focus-ring transition-all"
          >
