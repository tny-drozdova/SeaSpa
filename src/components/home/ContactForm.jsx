...
// inline=true: renders just the form content, no outer section wrapper (used in MapContactSection)
export default function ContactForm({ inline = false }) {
    ...
    <>
      <form onSubmit={handleSubmit} className="bg-muted rounded-lg p-5 sm:p-8 space-y-5" noValidate>
        ...
        <Button
          ...
          className="w-full bg-sky-horizon text-deep-atlantic font-body font-semibold py-5 border-[3px] border-transparent hover:bg-white hover:text-sky-horizon hover:border-[#1697CA] focus-ring transition-all disabled:opacity-50 disabled:cursor-not-allowed"
        >
