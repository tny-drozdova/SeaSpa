      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
        ...
        >
          ...
          >
            <Button
              size="lg"
              className="rounded-md bg-sky-horizon text-deep-atlantic font-body font-semibold px-10 py-6 text-lg shadow border-[3px] border-transparent hover:bg-white hover:text-sky-horizon hover:border-[#1697CA] focus-ring transition-all duration-200"
            >
              Book Your Escape
            </Button>
          </a>
