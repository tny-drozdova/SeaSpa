    ...
    <section
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
        <motion.div
          ...
          <p className="text-[hsl(var(--card))] mb-4 mx-auto text-base font-body leading-relaxed md:text-xl max-w-xl">A private hot tub boat experience on New Jersey Bay

          </p>
          <p className="text-[hsl(var(--border))] mb-10 mx-auto text-sm font-body md:text-base max-w-md">90 minutes of luxury, relaxation, and unforgettable views
