...
const UNIQUE_IMAGE = "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&q=80";
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
        ...
        <Link
          to={linkTo}
          className="inline-flex items-center gap-2 text-sky-horizon font-body font-semibold text-sm tracking-wide underline underline-offset-4 hover:text-white hover:gap-3 transition-all duration-300 focus-ring rounded-sm"
...
export default function ExperienceCards({ romanticImage, groupImage }) {
  return (
    <section id="experiences-hot-tub-boat-stone-harbor-NJ" className="py-24 md:py-40 bg-deep-atlantic glass-rule" aria-labelledby="experiences-heading">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          ...
          <ExperienceCard
            ...
            linkTo="/unique-experience-NJ"
            linkLabel="See what makes this a unique NJ experience"
            linkText="See What Makes It Unique"
            altText="Hot tub boat on Wildwood NJ bay with open water views"
          />
        </div>
      </div>
    </section>
